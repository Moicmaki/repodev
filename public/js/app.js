    ...
    if(typeof app !== 'undefined'){
        ...
        if(app.showCookiesBox !== null){
            ...
            let cookiesConsetOptions = {
                ...
                content: {
                    message: trans(`${trans('Ce site utilise des cookies pour améliorer votre expérience. En continuant à utiliser ce site, vous acceptez notre utilisation des cookies conformément à notre politique de confidentialité. Ce site est réservé aux adultes et propose du contenu réservé aux personnes de 18 ans et plus. En continuant, vous confirmez que vous avez 18 ans ou plus et acceptez nos conditions générales d\'utilisation.')}`),
                    dismiss: trans(`J'ai compris`),
                    link: trans('En savoir plus'),
                    href: "/pages/conditions-generales-d-utilisations"
                },
            };
            if(br.name === 'xs'){
