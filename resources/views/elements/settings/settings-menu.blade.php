    ...
    <div class="card-settings border-bottom">
        <div class="list-group list-group-sm list-group-flush">
            ...
            <a href="{{ route('my.settings', ['type' => $route]) }}"
                class="{{ $activeSettingsTab == $route ? 'active' : '' }} list-group-item list-group-item-action d-flex justify-content-between slugmenu_{{ $route }}">
                <div class="d-flex align-items-center">
                    @include('elements.icon', ['icon' => $setting['icon'].'-outline', 'centered' => 'false', 'classes'
                    => 'mr-3', 'variant' => 'medium'])
