    ...
    <div class="min-vh-100 col-12 col-md-8 border-right pr-md-0">
        ...
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <style>
                        ...
                        .is_createur,
                        h6.font-weight-bold.text-uppercase.mb-3,
                        button.btn.btn-round.btn-lg.btn-primary.btn-block.d-flex.justify-content-between.mt-3.mb-2.px-5.to-tooltip,
                        .profile-widgets-area     div.card.mt-3.rounded-lg{
                ...
                <div class="d-flex flex-row">
                    ...
                    @if($user->verification->compte_createur == 'oui')

                    <div class="">
                        <span class="p-pill ml-2 pointer-cursor to-tooltip" @if(!Auth::user()->email_verified_at &&
                            getSetting('site.enforce_email_validation'))
                            data-placement="top"
        ...
        <div class="container pt-2 pl-0 pr-0">
            ...
            <div class="pt-2 pl-4 pr-4">
                <h5 class="text-bold d-flex align-items-center">
                    <span>{{$user->name}}</span>
                    @if($user->email_verified_at && $user->birthdate && ($user->verification &&
            ...
            <div class="pt-2 pb-2 pl-4 pr-4 profile-description-holder">
                ...
                @if($user->bio && (strlen(trim(strip_tags(GenericHelper::parseProfileMarkdownBio($user->bio)))) >= 85 ||
                substr_count($user->bio,"\r\n") > 1) && !getSetting('profiles.disable_profile_bio_excerpt'))
            ...
            @if($user->paid_profile && (!getSetting('profiles.allow_users_enabling_open_profiles') ||
            ...
            <div class="p-4 subscription-holder">
                ...
                @endif
                @if($hasSub)
                <button class="btn btn-round btn-primary btn-block mt-3 mb-2 text-center">
                ...
                <div class="subscription-bundles d-none">
            ...
            <div class=" p-4 subscription-holder">
                ...
                @if(Auth::check())
                <button class="btn btn-round btn-primary btn-block mt-3 mb-0 manage-follow-button"
                ...
                @else
                <button class="btn btn-round btn-primary btn-block mt-3 mb-0 text-center" data-toggle="modal"
            ...
            <div
                ...
                <div class="streams-box mt-4 streams-wrapper mb-4">
                    @include('elements.search.streams-wrapper',['streams'=>$streams,'showLiveIndicators'=>true,
                    'showUsername' => false])
                </div>
                @endif
