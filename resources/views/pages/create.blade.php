...
<div class="row">
    <div class="col-12">
        ...
        @include('elements.post-schedule-setup', isset($post) ? ['release_date' => $post->release_date,'expire_date' =>
        $post->expire_date] : [])
                        ...
                        <div class="flex-md-grow-1">
                            <div class="d-md-flex d-block">
                                ...
                                <div class="form-group">
                                    <select name="publication_gratuite" id="publication_gratuite" class="form-control ml-md-4 ml-2 mt-4 mt-md-0">
                                        <option value="0" {{ isset($post) && $post->publication_gratuite == 0 ? 'selected' : '' }}>{{ __('Abonnement') }}</option>
                                        <option value="1" {{ isset($post) && $post->publication_gratuite == 1 ? 'selected' : '' }}>{{ __('Sans abonnement') }}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
